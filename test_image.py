...
parser.add_argument('--image', default="/home/vasu/Downloads/aaaaaaa.jpeg", type=str, help='dataset')
...
if __name__ == '__main__':
    ...
    print('forward_pass_time: {:.4f}s misc: {:.4f}s'.format(_t['forward_pass'].average_time, _t['misc'].average_time))
